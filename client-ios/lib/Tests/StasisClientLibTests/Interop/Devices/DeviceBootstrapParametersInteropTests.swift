...
@Suite("DeviceBootstrapParameters interop")
struct DeviceBootstrapParametersInteropTests {
    @Test("decode and re-encode bootstrap parameters")
    func bootstrapParameters() throws {
        try assert(
            domain: "devices",
    ...
    private static let expected = DeviceBootstrapParameters(
