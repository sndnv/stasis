...
import stasis.server.api.Endpoint
import stasis.server.model.datasets.{DatasetDefinition, DatasetDefinitionStore, DatasetEntry, DatasetEntryStore}
...
class EndpointSpec extends AsyncUnitSpec with ScalatestRouteTest {
  import scala.language.implicitConversions

  import de.heikoseeberger.akkahttpplayjson.PlayJsonSupport._
  import stasis.server.api.Formats._

  private implicit val untypedSystem: ActorSystem = ActorSystem(name = "EndpointSpec")
  ...
  private trait TestFixtures {
    ...
    lazy val endpoint: Endpoint = new Endpoint(provider, authenticator)
  }
  ...
  "An Endpoint" should "successfully authenticate a user" in {
