package stasis.test.specs.unit.persistence.backends.file.container.stream.transform
...
import stasis.persistence.backends.file.container.stream.transform.CrateToChunks
