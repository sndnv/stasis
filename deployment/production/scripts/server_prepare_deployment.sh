...
log_info "        Keystore - identity: ${SECRETS_DIR}/identity.stasis.internal.p12"
log_info "        Keystore - server:   ${SECRETS_DIR}/server.stasis.internal.p12"
log_info "        TLS cert - identity: ${SECRETS_DIR}/identity.stasis.internal.cert.pem"
log_info "        TLS key - identity:  ${SECRETS_DIR}/identity.stasis.internal.key.pem"
log_info "        TLS cert - server:   ${SECRETS_DIR}/server.stasis.internal.cert.pem"
log_info "        TLS key - server:    ${SECRETS_DIR}/server.stasis.internal.key.pem"
...
log_info "    - Adjust DNS configuration (see README file)"
log_info "    - Bootstrap services (see README file)"
