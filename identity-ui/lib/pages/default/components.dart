      ...
      if (snapshot.data != null && snapshot.connectionState == ConnectionState.done) {
        ...
        return centerContent(
          content: [
            createBasicCard(
              theme,
              [_errorInfo(title: 'Authentication Failed', description: 'Failed to authenticate; try to log in again.')],
            )
          ],
        );
        ...
        return centerContent(
          content: [
            createBasicCard(
              theme,
              [_errorInfo(title: 'Not Authorized', description: 'Access to this resource is not allowed.')],
            )
          ],
        );
        ...
        return centerContent(
          content: [
            createBasicCard(
              theme,
              [_errorInfo(title: 'Error', description: snapshot.error.toString())],
            )
          ],
        );
      } else {
...
Widget _errorInfo({required String title, required String description}) {
  return Center(
    child: ListTile(
