...
class ApiPackageSpec(unittest.TestCase):
    ...
    def test_should_create_default_client_api_with_custom_https_context(self, mock_create_pem):
        api = create_api(
    ...
    def test_should_create_default_client_api_with_default_https_context(self):
        api = create_api(
    ...
    def test_should_create_default_client_api_with_allowed_insecure_https_connections(self):
        api = create_api(
            config=ApiPackageSpec.create_config(with_context=False),
            api_token='test-token',
            insecure=True
